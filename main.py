print("Nous somme Tres fier des vous présanter la version ALPHA de Médianne")
print("voici les différantes options que Médianne propose actuellement:")
print("=====> Médiamaths(1)")
while True:
    choice0=int(input("quel option avez-vous choisit?:"))
    if choice0==(1):
        print("bien veunue dans Médiamaths Alpha")
        print("multiplication uniquement(1)")
        print("division uniquement(2)")
        print("aditions uniquement(3)")
        print("soustractions uniquement(4)")
        print("toutes les operations comprises(5)")
        print("theorème de Pythagore(6)")
        print("reciproque du thorème de Pythagore(7)")
        ...
        if choice1==(1):
            ...
            print("veuillez inserer une valeur de base")
            aaa=int(input("====>"))
            ...
            print(result)
            while True:
                print("veuillez entrer une valeur au quel le tout va etre divisé")
                aca=int(input("====>"))
                result=result/aca
                print(result)
            ...
            ag=int(input("=====>"))
            print("veuillez inserer une valeur qui va etre enlevé a l'egalitée précedante:")
            ah=int(input("=====>"))
            result=ag-ah
            print(result)
            while True:
            ...
            while True:
                aa=input("comment se nome votre trangle?")
                print("dans votre triangle",aa,",quel est l'hypoténus?")
                ab=(input("=====>"))
    
                print("dans",aa,"comment s'apelle le dernier coté? ")
                ad=input("=====>")
                print("hypotenus==",ab)
                print(" coté=",ad)
                ...
                if ba=="oui":
                    ...
                    import math
                    fg=math.sqrt(res)
                    print(" la valeur manquante est",fg)
        ...
        print("désolé, votre demmande n'a pas été comprise...")